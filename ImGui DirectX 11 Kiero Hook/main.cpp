...
void SetupConsole() {
    ...
    // Manual override for testing - force PersistentLevel offset to 0x30
    g_OffsetLoader->SetOffset("UWorld::PersistentLevel", 0x30);
    std::cout << "DEBUG: Manually set UWorld::PersistentLevel to 0x30" << std::endl;
