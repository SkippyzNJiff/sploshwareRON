...
static_assert(offsetof(W_RadialSelectionBase_C_Select, Index_0) == 0x000000, "Member 'W_RadialSelectionBase_C_Select::Index_0' has a wrong offset!");
...
static_assert(alignof(W_RadialSelectionBase_C_UpdateIcon) == 0x000010, "Wrong alignment on W_RadialSelectionBase_C_UpdateIcon");
static_assert(sizeof(W_RadialSelectionBase_C_UpdateIcon) == 0x0000E0, "Wrong size on W_RadialSelectionBase_C_UpdateIcon");
...
static_assert(offsetof(W_RadialSelectionBase_C_UpdateIcon, InBrush) == 0x000010, "Member 'W_RadialSelectionBase_C_UpdateIcon::InBrush' has a wrong offset!");
