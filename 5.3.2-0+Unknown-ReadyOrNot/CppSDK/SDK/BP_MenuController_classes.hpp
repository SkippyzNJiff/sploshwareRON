...
static_assert(sizeof(ABP_MenuController_C) == 0x000D40, "Wrong size on ABP_MenuController_C");
static_assert(offsetof(ABP_MenuController_C, UberGraphFrame) == 0x000D28, "Member 'ABP_MenuController_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABP_MenuController_C, UI_PartyPanel) == 0x000D30, "Member 'ABP_MenuController_C::UI_PartyPanel' has a wrong offset!");
static_assert(offsetof(ABP_MenuController_C, ReplaySystemWidget) == 0x000D38, "Member 'ABP_MenuController_C::ReplaySystemWidget' has a wrong offset!");
