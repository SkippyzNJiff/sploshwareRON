...
static_assert(sizeof(ABP_MenuGameMode_C) == 0x000438, "Wrong size on ABP_MenuGameMode_C");
static_assert(offsetof(ABP_MenuGameMode_C, UberGraphFrame) == 0x000408, "Member 'ABP_MenuGameMode_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABP_MenuGameMode_C, DefaultSceneRoot) == 0x000410, "Member 'ABP_MenuGameMode_C::DefaultSceneRoot' has a wrong offset!");
static_assert(offsetof(ABP_MenuGameMode_C, RandomMapInt) == 0x000418, "Member 'ABP_MenuGameMode_C::RandomMapInt' has a wrong offset!");
static_assert(offsetof(ABP_MenuGameMode_C, ConnectingWidget) == 0x000420, "Member 'ABP_MenuGameMode_C::ConnectingWidget' has a wrong offset!");
static_assert(offsetof(ABP_MenuGameMode_C, RequestRestart) == 0x000428, "Member 'ABP_MenuGameMode_C::RequestRestart' has a wrong offset!");
static_assert(offsetof(ABP_MenuGameMode_C, CurrentDispalyBox) == 0x000430, "Member 'ABP_MenuGameMode_C::CurrentDispalyBox' has a wrong offset!");
