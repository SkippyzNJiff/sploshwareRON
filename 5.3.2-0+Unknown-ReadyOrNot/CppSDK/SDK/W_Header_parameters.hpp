...
static_assert(sizeof(W_Header_C_ExecuteUbergraph_W_Header) == 0x000078, "Wrong size on W_Header_C_ExecuteUbergraph_W_Header");
...
static_assert(offsetof(W_Header_C_ExecuteUbergraph_W_Header, K2Node_Event_Delay) == 0x000038, "Member 'W_Header_C_ExecuteUbergraph_W_Header::K2Node_Event_Delay' has a wrong offset!");
static_assert(offsetof(W_Header_C_ExecuteUbergraph_W_Header, K2Node_Event_Collapse) == 0x000040, "Member 'W_Header_C_ExecuteUbergraph_W_Header::K2Node_Event_Collapse' has a wrong offset!");
static_assert(offsetof(W_Header_C_ExecuteUbergraph_W_Header, CallFunc_PlayAnimationForward_ReturnValue) == 0x000048, "Member 'W_Header_C_ExecuteUbergraph_W_Header::CallFunc_PlayAnimationForward_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Header_C_ExecuteUbergraph_W_Header, CallFunc_PlayAnimationReverse_ReturnValue) == 0x000050, "Member 'W_Header_C_ExecuteUbergraph_W_Header::CallFunc_PlayAnimationReverse_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Header_C_ExecuteUbergraph_W_Header, K2Node_MakeStruct_LinearColor) == 0x000058, "Member 'W_Header_C_ExecuteUbergraph_W_Header::K2Node_MakeStruct_LinearColor' has a wrong offset!");
static_assert(offsetof(W_Header_C_ExecuteUbergraph_W_Header, CallFunc_Delay_Duration_ImplicitCast) == 0x000068, "Member 'W_Header_C_ExecuteUbergraph_W_Header::CallFunc_Delay_Duration_ImplicitCast' has a wrong offset!");
static_assert(offsetof(W_Header_C_ExecuteUbergraph_W_Header, CallFunc_Delay_Duration_ImplicitCast_1) == 0x00006C, "Member 'W_Header_C_ExecuteUbergraph_W_Header::CallFunc_Delay_Duration_ImplicitCast_1' has a wrong offset!");
static_assert(offsetof(W_Header_C_ExecuteUbergraph_W_Header, CallFunc_SetRenderOpacity_InOpacity_ImplicitCast) == 0x000070, "Member 'W_Header_C_ExecuteUbergraph_W_Header::CallFunc_SetRenderOpacity_InOpacity_ImplicitCast' has a wrong offset!");
static_assert(offsetof(W_Header_C_ExecuteUbergraph_W_Header, K2Node_MakeStruct_A_ImplicitCast) == 0x000074, "Member 'W_Header_C_ExecuteUbergraph_W_Header::K2Node_MakeStruct_A_ImplicitCast' has a wrong offset!");
...
static_assert(offsetof(W_Header_C_HasAugment, HasAugment_0) == 0x000000, "Member 'W_Header_C_HasAugment::HasAugment_0' has a wrong offset!");
...
static_assert(alignof(W_Header_C_Hide) == 0x000008, "Wrong alignment on W_Header_C_Hide");
static_assert(sizeof(W_Header_C_Hide) == 0x000010, "Wrong size on W_Header_C_Hide");
static_assert(offsetof(W_Header_C_Hide, Delay) == 0x000000, "Member 'W_Header_C_Hide::Delay' has a wrong offset!");
static_assert(offsetof(W_Header_C_Hide, Collapse) == 0x000008, "Member 'W_Header_C_Hide::Collapse' has a wrong offset!");
...
static_assert(offsetof(W_Header_C_Initialize, LabelText_0) == 0x000000, "Member 'W_Header_C_Initialize::LabelText_0' has a wrong offset!");
...
static_assert(alignof(W_Header_C_Reveal) == 0x000008, "Wrong alignment on W_Header_C_Reveal");
static_assert(sizeof(W_Header_C_Reveal) == 0x000008, "Wrong size on W_Header_C_Reveal");
...
static_assert(offsetof(W_Header_C_SetLabel, LabelText_0) == 0x000000, "Member 'W_Header_C_SetLabel::LabelText_0' has a wrong offset!");
...
static_assert(alignof(W_Header_C_SetLayout) == 0x000008, "Wrong alignment on W_Header_C_SetLayout");
static_assert(sizeof(W_Header_C_SetLayout) == 0x000048, "Wrong size on W_Header_C_SetLayout");
static_assert(offsetof(W_Header_C_SetLayout, Layout_0) == 0x000000, "Member 'W_Header_C_SetLayout::Layout_0' has a wrong offset!");
...
static_assert(offsetof(W_Header_C_SetLayout, Temp_real_Variable) == 0x000008, "Member 'W_Header_C_SetLayout::Temp_real_Variable' has a wrong offset!");
static_assert(offsetof(W_Header_C_SetLayout, Temp_real_Variable_1) == 0x000010, "Member 'W_Header_C_SetLayout::Temp_real_Variable_1' has a wrong offset!");
static_assert(offsetof(W_Header_C_SetLayout, Temp_real_Variable_2) == 0x000018, "Member 'W_Header_C_SetLayout::Temp_real_Variable_2' has a wrong offset!");
static_assert(offsetof(W_Header_C_SetLayout, Temp_real_Variable_3) == 0x000020, "Member 'W_Header_C_SetLayout::Temp_real_Variable_3' has a wrong offset!");
static_assert(offsetof(W_Header_C_SetLayout, Temp_bool_Variable) == 0x000028, "Member 'W_Header_C_SetLayout::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(W_Header_C_SetLayout, Temp_byte_Variable_1) == 0x000029, "Member 'W_Header_C_SetLayout::Temp_byte_Variable_1' has a wrong offset!");
static_assert(offsetof(W_Header_C_SetLayout, Temp_byte_Variable_2) == 0x00002A, "Member 'W_Header_C_SetLayout::Temp_byte_Variable_2' has a wrong offset!");
static_assert(offsetof(W_Header_C_SetLayout, CallFunc_Not_PreBool_ReturnValue) == 0x00002B, "Member 'W_Header_C_SetLayout::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Header_C_SetLayout, CallFunc_HasAugment_HasAugment) == 0x00002C, "Member 'W_Header_C_SetLayout::CallFunc_HasAugment_HasAugment' has a wrong offset!");
static_assert(offsetof(W_Header_C_SetLayout, K2Node_Select_Default) == 0x00002D, "Member 'W_Header_C_SetLayout::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(W_Header_C_SetLayout, K2Node_Select_Default_1) == 0x000030, "Member 'W_Header_C_SetLayout::K2Node_Select_Default_1' has a wrong offset!");
static_assert(offsetof(W_Header_C_SetLayout, CallFunc_MakeVector2D_ReturnValue) == 0x000038, "Member 'W_Header_C_SetLayout::CallFunc_MakeVector2D_ReturnValue' has a wrong offset!");
