...
static_assert(alignof(FCoverPointIndex) == 0x000008, "Wrong alignment on FCoverPointIndex");
static_assert(sizeof(FCoverPointIndex) == 0x000020, "Wrong size on FCoverPointIndex");
static_assert(offsetof(FCoverPointIndex, Location) == 0x000000, "Member 'FCoverPointIndex::Location' has a wrong offset!");
static_assert(offsetof(FCoverPointIndex, Index) == 0x000018, "Member 'FCoverPointIndex::Index' has a wrong offset!");
...
static_assert(sizeof(FCoverRail) == 0x000058, "Wrong size on FCoverRail");
static_assert(offsetof(FCoverRail, Start) == 0x000000, "Member 'FCoverRail::Start' has a wrong offset!");
static_assert(offsetof(FCoverRail, End) == 0x000018, "Member 'FCoverRail::End' has a wrong offset!");
static_assert(offsetof(FCoverRail, Direction) == 0x000030, "Member 'FCoverRail::Direction' has a wrong offset!");
static_assert(offsetof(FCoverRail, CoverPoints) == 0x000048, "Member 'FCoverRail::CoverPoints' has a wrong offset!");
...
static_assert(alignof(FCoverDirection) == 0x000008, "Wrong alignment on FCoverDirection");
static_assert(sizeof(FCoverDirection) == 0x000030, "Wrong size on FCoverDirection");
static_assert(offsetof(FCoverDirection, Left) == 0x000000, "Member 'FCoverDirection::Left' has a wrong offset!");
static_assert(offsetof(FCoverDirection, Right) == 0x000018, "Member 'FCoverDirection::Right' has a wrong offset!");
