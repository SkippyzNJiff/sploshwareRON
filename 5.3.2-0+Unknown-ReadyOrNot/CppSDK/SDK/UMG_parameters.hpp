...
static_assert(alignof(TextBlock_SetCharacterLimit) == 0x000004, "Wrong alignment on TextBlock_SetCharacterLimit");
static_assert(sizeof(TextBlock_SetCharacterLimit) == 0x000004, "Wrong size on TextBlock_SetCharacterLimit");
static_assert(offsetof(TextBlock_SetCharacterLimit, InCharacterLimit) == 0x000000, "Member 'TextBlock_SetCharacterLimit::InCharacterLimit' has a wrong offset!");
...
static_assert(alignof(TextBlock_SetTruncationCharacters) == 0x000008, "Wrong alignment on TextBlock_SetTruncationCharacters");
static_assert(sizeof(TextBlock_SetTruncationCharacters) == 0x000010, "Wrong size on TextBlock_SetTruncationCharacters");
static_assert(offsetof(TextBlock_SetTruncationCharacters, InTruncationCharacters) == 0x000000, "Member 'TextBlock_SetTruncationCharacters::InTruncationCharacters' has a wrong offset!");
...
static_assert(alignof(TextBlock_GetCharacterLimit) == 0x000004, "Wrong alignment on TextBlock_GetCharacterLimit");
static_assert(sizeof(TextBlock_GetCharacterLimit) == 0x000004, "Wrong size on TextBlock_GetCharacterLimit");
static_assert(offsetof(TextBlock_GetCharacterLimit, ReturnValue) == 0x000000, "Member 'TextBlock_GetCharacterLimit::ReturnValue' has a wrong offset!");
...
static_assert(alignof(TextBlock_GetTruncationCharacters) == 0x000008, "Wrong alignment on TextBlock_GetTruncationCharacters");
static_assert(sizeof(TextBlock_GetTruncationCharacters) == 0x000010, "Wrong size on TextBlock_GetTruncationCharacters");
static_assert(offsetof(TextBlock_GetTruncationCharacters, ReturnValue) == 0x000000, "Member 'TextBlock_GetTruncationCharacters::ReturnValue' has a wrong offset!");
