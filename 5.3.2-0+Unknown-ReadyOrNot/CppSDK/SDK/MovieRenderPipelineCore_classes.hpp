...
static_assert(offsetof(UMovieGraphMember, Name_0) == 0x000048, "Member 'UMovieGraphMember::Name_0' has a wrong offset!");
...
static_assert(offsetof(UMovieGraphGetCVarValueNode, Name_0) == 0x000098, "Member 'UMovieGraphGetCVarValueNode::Name_0' has a wrong offset!");
...
static_assert(offsetof(UMovieGraphSetCVarValueNode, Name_0) == 0x000098, "Member 'UMovieGraphSetCVarValueNode::Name_0' has a wrong offset!");
