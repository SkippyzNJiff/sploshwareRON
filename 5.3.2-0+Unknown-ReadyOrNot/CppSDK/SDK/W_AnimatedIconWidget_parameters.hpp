...
static_assert(offsetof(W_AnimatedIconWidget_C_ExecuteUbergraph_W_AnimatedIconWidget, Temp_real_Variable) == 0x000020, "Member 'W_AnimatedIconWidget_C_ExecuteUbergraph_W_AnimatedIconWidget::Temp_real_Variable' has a wrong offset!");
static_assert(offsetof(W_AnimatedIconWidget_C_ExecuteUbergraph_W_AnimatedIconWidget, Temp_real_Variable_1) == 0x000028, "Member 'W_AnimatedIconWidget_C_ExecuteUbergraph_W_AnimatedIconWidget::Temp_real_Variable_1' has a wrong offset!");
static_assert(offsetof(W_AnimatedIconWidget_C_ExecuteUbergraph_W_AnimatedIconWidget, K2Node_Event_bValid) == 0x000030, "Member 'W_AnimatedIconWidget_C_ExecuteUbergraph_W_AnimatedIconWidget::K2Node_Event_bValid' has a wrong offset!");
static_assert(offsetof(W_AnimatedIconWidget_C_ExecuteUbergraph_W_AnimatedIconWidget, K2Node_Select_Default) == 0x000038, "Member 'W_AnimatedIconWidget_C_ExecuteUbergraph_W_AnimatedIconWidget::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(W_AnimatedIconWidget_C_ExecuteUbergraph_W_AnimatedIconWidget, K2Node_Select_Default_1) == 0x000040, "Member 'W_AnimatedIconWidget_C_ExecuteUbergraph_W_AnimatedIconWidget::K2Node_Select_Default_1' has a wrong offset!");
static_assert(offsetof(W_AnimatedIconWidget_C_ExecuteUbergraph_W_AnimatedIconWidget, K2Node_MakeStruct_SlateColor) == 0x000050, "Member 'W_AnimatedIconWidget_C_ExecuteUbergraph_W_AnimatedIconWidget::K2Node_MakeStruct_SlateColor' has a wrong offset!");
static_assert(offsetof(W_AnimatedIconWidget_C_ExecuteUbergraph_W_AnimatedIconWidget, CallFunc_SetRenderOpacity_InOpacity_ImplicitCast) == 0x000064, "Member 'W_AnimatedIconWidget_C_ExecuteUbergraph_W_AnimatedIconWidget::CallFunc_SetRenderOpacity_InOpacity_ImplicitCast' has a wrong offset!");
