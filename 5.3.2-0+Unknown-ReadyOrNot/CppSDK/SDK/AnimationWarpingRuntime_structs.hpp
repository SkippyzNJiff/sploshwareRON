...
static_assert(sizeof(FAnimNode_OrientationWarping) == 0x000260, "Wrong size on FAnimNode_OrientationWarping");
...
static_assert(offsetof(FAnimNode_OrientationWarping, TargetTime) == 0x0000CC, "Member 'FAnimNode_OrientationWarping::TargetTime' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, OrientationAngle) == 0x0000D0, "Member 'FAnimNode_OrientationWarping::OrientationAngle' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, LocomotionAngle) == 0x0000D4, "Member 'FAnimNode_OrientationWarping::LocomotionAngle' has a wrong offset!");
...
static_assert(offsetof(FAnimNode_OrientationWarping, CurrentAnimAsset) == 0x000128, "Member 'FAnimNode_OrientationWarping::CurrentAnimAsset' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, CurrentAnimAssetTime) == 0x000130, "Member 'FAnimNode_OrientationWarping::CurrentAnimAssetTime' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, RotationAxis) == 0x000134, "Member 'FAnimNode_OrientationWarping::RotationAxis' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, DistributedBoneOrientationAlpha) == 0x000138, "Member 'FAnimNode_OrientationWarping::DistributedBoneOrientationAlpha' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, RotationInterpSpeed) == 0x00013C, "Member 'FAnimNode_OrientationWarping::RotationInterpSpeed' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, CounterCompensateInterpSpeed) == 0x000140, "Member 'FAnimNode_OrientationWarping::CounterCompensateInterpSpeed' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, MaxCorrectionDegrees) == 0x000144, "Member 'FAnimNode_OrientationWarping::MaxCorrectionDegrees' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, MaxRootMotionDeltaToCompensateDegrees) == 0x000148, "Member 'FAnimNode_OrientationWarping::MaxRootMotionDeltaToCompensateDegrees' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, bCounterCompenstateInterpolationByRootMotion) == 0x00014C, "Member 'FAnimNode_OrientationWarping::bCounterCompenstateInterpolationByRootMotion' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, bScaleByGlobalBlendWeight) == 0x00014D, "Member 'FAnimNode_OrientationWarping::bScaleByGlobalBlendWeight' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, bUseManualRootMotionVelocity) == 0x00014E, "Member 'FAnimNode_OrientationWarping::bUseManualRootMotionVelocity' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, ManualRootMotionVelocity) == 0x000150, "Member 'FAnimNode_OrientationWarping::ManualRootMotionVelocity' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, WarpingSpace) == 0x000168, "Member 'FAnimNode_OrientationWarping::WarpingSpace' has a wrong offset!");
static_assert(offsetof(FAnimNode_OrientationWarping, WarpingSpaceTransform) == 0x000170, "Member 'FAnimNode_OrientationWarping::WarpingSpaceTransform' has a wrong offset!");
