...
static_assert(sizeof(W_FireModes_C_ExecuteUbergraph_W_FireModes) == 0x000040, "Wrong size on W_FireModes_C_ExecuteUbergraph_W_FireModes");
...
static_assert(offsetof(W_FireModes_C_ExecuteUbergraph_W_FireModes, CallFunc_K2_SetTimerDelegate_Time_ImplicitCast) == 0x000038, "Member 'W_FireModes_C_ExecuteUbergraph_W_FireModes::CallFunc_K2_SetTimerDelegate_Time_ImplicitCast' has a wrong offset!");
...
static_assert(sizeof(W_FireModes_C_SetFireMode) == 0x000028, "Wrong size on W_FireModes_C_SetFireMode");
...
static_assert(offsetof(W_FireModes_C_SetFireMode, CallFunc_K2_SetTimerDelegate_Time_ImplicitCast) == 0x000020, "Member 'W_FireModes_C_SetFireMode::CallFunc_K2_SetTimerDelegate_Time_ImplicitCast' has a wrong offset!");
