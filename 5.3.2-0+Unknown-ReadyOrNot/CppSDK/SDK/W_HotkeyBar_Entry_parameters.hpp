...
static_assert(alignof(W_HotkeyBar_Entry_C_ExecuteUbergraph_W_HotkeyBar_Entry) == 0x000010, "Wrong alignment on W_HotkeyBar_Entry_C_ExecuteUbergraph_W_HotkeyBar_Entry");
static_assert(sizeof(W_HotkeyBar_Entry_C_ExecuteUbergraph_W_HotkeyBar_Entry) == 0x000220, "Wrong size on W_HotkeyBar_Entry_C_ExecuteUbergraph_W_HotkeyBar_Entry");
...
static_assert(offsetof(W_HotkeyBar_Entry_C_ExecuteUbergraph_W_HotkeyBar_Entry, K2Node_ComponentBoundEvent_Button) == 0x0001D0, "Member 'W_HotkeyBar_Entry_C_ExecuteUbergraph_W_HotkeyBar_Entry::K2Node_ComponentBoundEvent_Button' has a wrong offset!");
static_assert(offsetof(W_HotkeyBar_Entry_C_ExecuteUbergraph_W_HotkeyBar_Entry, Temp_bool_Variable_2) == 0x0001D8, "Member 'W_HotkeyBar_Entry_C_ExecuteUbergraph_W_HotkeyBar_Entry::Temp_bool_Variable_2' has a wrong offset!");
static_assert(offsetof(W_HotkeyBar_Entry_C_ExecuteUbergraph_W_HotkeyBar_Entry, CallFunc_GetReadyOrNotPlayerController_ReturnValue) == 0x0001E0, "Member 'W_HotkeyBar_Entry_C_ExecuteUbergraph_W_HotkeyBar_Entry::CallFunc_GetReadyOrNotPlayerController_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_HotkeyBar_Entry_C_ExecuteUbergraph_W_HotkeyBar_Entry, CallFunc_GetLocalPlayerSubSystemFromPlayerController_ReturnValue) == 0x0001E8, "Member 'W_HotkeyBar_Entry_C_ExecuteUbergraph_W_HotkeyBar_Entry::CallFunc_GetLocalPlayerSubSystemFromPlayerController_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_HotkeyBar_Entry_C_ExecuteUbergraph_W_HotkeyBar_Entry, K2Node_Select_Default_2) == 0x0001F0, "Member 'W_HotkeyBar_Entry_C_ExecuteUbergraph_W_HotkeyBar_Entry::K2Node_Select_Default_2' has a wrong offset!");
static_assert(offsetof(W_HotkeyBar_Entry_C_ExecuteUbergraph_W_HotkeyBar_Entry, CallFunc_GetReadyOrNotPlayerController_ReturnValue_1) == 0x000208, "Member 'W_HotkeyBar_Entry_C_ExecuteUbergraph_W_HotkeyBar_Entry::CallFunc_GetReadyOrNotPlayerController_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_HotkeyBar_Entry_C_ExecuteUbergraph_W_HotkeyBar_Entry, CallFunc_GetLocalPlayerSubSystemFromPlayerController_ReturnValue_1) == 0x000210, "Member 'W_HotkeyBar_Entry_C_ExecuteUbergraph_W_HotkeyBar_Entry::CallFunc_GetLocalPlayerSubSystemFromPlayerController_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_HotkeyBar_Entry_C_ExecuteUbergraph_W_HotkeyBar_Entry, CallFunc_GetCurrentInputType_ReturnValue) == 0x000218, "Member 'W_HotkeyBar_Entry_C_ExecuteUbergraph_W_HotkeyBar_Entry::CallFunc_GetCurrentInputType_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(W_HotkeyBar_Entry_C_SetBinding, Hotkey_0) == 0x000000, "Member 'W_HotkeyBar_Entry_C_SetBinding::Hotkey_0' has a wrong offset!");
