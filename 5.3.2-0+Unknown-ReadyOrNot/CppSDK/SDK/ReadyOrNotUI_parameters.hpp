...
static_assert(alignof(ReadyOrNotUI_C_Hide) == 0x000008, "Wrong alignment on ReadyOrNotUI_C_Hide");
static_assert(sizeof(ReadyOrNotUI_C_Hide) == 0x000010, "Wrong size on ReadyOrNotUI_C_Hide");
static_assert(offsetof(ReadyOrNotUI_C_Hide, Delay) == 0x000000, "Member 'ReadyOrNotUI_C_Hide::Delay' has a wrong offset!");
static_assert(offsetof(ReadyOrNotUI_C_Hide, Collapse) == 0x000008, "Member 'ReadyOrNotUI_C_Hide::Collapse' has a wrong offset!");
...
static_assert(alignof(ReadyOrNotUI_C_Reveal) == 0x000008, "Wrong alignment on ReadyOrNotUI_C_Reveal");
static_assert(sizeof(ReadyOrNotUI_C_Reveal) == 0x000008, "Wrong size on ReadyOrNotUI_C_Reveal");
