...
static_assert(sizeof(UObjectPoolComponent) == 0x000110, "Wrong size on UObjectPoolComponent");
static_assert(offsetof(UObjectPoolComponent, OnActorRetrievedFromPool) == 0x0000A0, "Member 'UObjectPoolComponent::OnActorRetrievedFromPool' has a wrong offset!");
static_assert(offsetof(UObjectPoolComponent, OnActorReturnedToPool) == 0x0000B0, "Member 'UObjectPoolComponent::OnActorReturnedToPool' has a wrong offset!");
static_assert(offsetof(UObjectPoolComponent, PoolName) == 0x0000C0, "Member 'UObjectPoolComponent::PoolName' has a wrong offset!");
static_assert(offsetof(UObjectPoolComponent, PoolSize) == 0x0000C8, "Member 'UObjectPoolComponent::PoolSize' has a wrong offset!");
static_assert(offsetof(UObjectPoolComponent, ReuseSetting) == 0x0000CC, "Member 'UObjectPoolComponent::ReuseSetting' has a wrong offset!");
static_assert(offsetof(UObjectPoolComponent, ObjectClassToPool) == 0x0000D0, "Member 'UObjectPoolComponent::ObjectClassToPool' has a wrong offset!");
static_assert(offsetof(UObjectPoolComponent, WarmUp) == 0x0000DA, "Member 'UObjectPoolComponent::WarmUp' has a wrong offset!");
static_assert(offsetof(UObjectPoolComponent, PooledActors) == 0x0000E8, "Member 'UObjectPoolComponent::PooledActors' has a wrong offset!");
...
static_assert(sizeof(APooledActor) == 0x0002E0, "Wrong size on APooledActor");
static_assert(offsetof(APooledActor, InUse) == 0x000298, "Member 'APooledActor::InUse' has a wrong offset!");
static_assert(offsetof(APooledActor, NotInUse) == 0x0002A8, "Member 'APooledActor::NotInUse' has a wrong offset!");
static_assert(offsetof(APooledActor, MaxLifespan) == 0x0002B8, "Member 'APooledActor::MaxLifespan' has a wrong offset!");
static_assert(offsetof(APooledActor, ElapsedTime) == 0x0002C0, "Member 'APooledActor::ElapsedTime' has a wrong offset!");
static_assert(offsetof(APooledActor, PoolOwner) == 0x0002C8, "Member 'APooledActor::PoolOwner' has a wrong offset!");
static_assert(offsetof(APooledActor, PoolOwner_Component) == 0x0002D0, "Member 'APooledActor::PoolOwner_Component' has a wrong offset!");
