...
static_assert(alignof(W_SubtitlesOverlay_C_ExecuteUbergraph_W_SubtitlesOverlay) == 0x000008, "Wrong alignment on W_SubtitlesOverlay_C_ExecuteUbergraph_W_SubtitlesOverlay");
static_assert(sizeof(W_SubtitlesOverlay_C_ExecuteUbergraph_W_SubtitlesOverlay) == 0x000038, "Wrong size on W_SubtitlesOverlay_C_ExecuteUbergraph_W_SubtitlesOverlay");
...
static_assert(offsetof(W_SubtitlesOverlay_C_ExecuteUbergraph_W_SubtitlesOverlay, Temp_real_Variable) == 0x000008, "Member 'W_SubtitlesOverlay_C_ExecuteUbergraph_W_SubtitlesOverlay::Temp_real_Variable' has a wrong offset!");
static_assert(offsetof(W_SubtitlesOverlay_C_ExecuteUbergraph_W_SubtitlesOverlay, Temp_real_Variable_1) == 0x000010, "Member 'W_SubtitlesOverlay_C_ExecuteUbergraph_W_SubtitlesOverlay::Temp_real_Variable_1' has a wrong offset!");
static_assert(offsetof(W_SubtitlesOverlay_C_ExecuteUbergraph_W_SubtitlesOverlay, Temp_real_Variable_2) == 0x000018, "Member 'W_SubtitlesOverlay_C_ExecuteUbergraph_W_SubtitlesOverlay::Temp_real_Variable_2' has a wrong offset!");
static_assert(offsetof(W_SubtitlesOverlay_C_ExecuteUbergraph_W_SubtitlesOverlay, Temp_real_Variable_3) == 0x000020, "Member 'W_SubtitlesOverlay_C_ExecuteUbergraph_W_SubtitlesOverlay::Temp_real_Variable_3' has a wrong offset!");
static_assert(offsetof(W_SubtitlesOverlay_C_ExecuteUbergraph_W_SubtitlesOverlay, K2Node_Select_Default) == 0x000028, "Member 'W_SubtitlesOverlay_C_ExecuteUbergraph_W_SubtitlesOverlay::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(W_SubtitlesOverlay_C_ExecuteUbergraph_W_SubtitlesOverlay, CallFunc_SetUserSpecifiedScale_InUserSpecifiedScale_ImplicitCast) == 0x000030, "Member 'W_SubtitlesOverlay_C_ExecuteUbergraph_W_SubtitlesOverlay::CallFunc_SetUserSpecifiedScale_InUserSpecifiedScale_ImplicitCast' has a wrong offset!");
