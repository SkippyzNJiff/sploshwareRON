...
static_assert(alignof(UW_Hotkeys_C) == 0x000010, "Wrong alignment on UW_Hotkeys_C");
static_assert(sizeof(UW_Hotkeys_C) == 0x000830, "Wrong size on UW_Hotkeys_C");
static_assert(offsetof(UW_Hotkeys_C, UberGraphFrame) == 0x000820, "Member 'UW_Hotkeys_C::UberGraphFrame' has a wrong offset!");
