...
static_assert(sizeof(W_Text_C_ExecuteUbergraph_W_Text) == 0x000120, "Wrong size on W_Text_C_ExecuteUbergraph_W_Text");
...
static_assert(offsetof(W_Text_C_ExecuteUbergraph_W_Text, CallFunc_GetDataTableRowFromName_ReturnValue) == 0x000118, "Member 'W_Text_C_ExecuteUbergraph_W_Text::CallFunc_GetDataTableRowFromName_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Text_C_ExecuteUbergraph_W_Text, CallFunc_NotEqual_LinearColorLinearColor_ReturnValue) == 0x000119, "Member 'W_Text_C_ExecuteUbergraph_W_Text::CallFunc_NotEqual_LinearColorLinearColor_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Text_C_ExecuteUbergraph_W_Text, CallFunc_GreaterEqual_IntInt_ReturnValue) == 0x00011A, "Member 'W_Text_C_ExecuteUbergraph_W_Text::CallFunc_GreaterEqual_IntInt_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(W_Text_C_GetText, CurrentText_0) == 0x000000, "Member 'W_Text_C_GetText::CurrentText_0' has a wrong offset!");
...
static_assert(sizeof(W_Text_C_SetFont) == 0x000120, "Wrong size on W_Text_C_SetFont");
...
static_assert(sizeof(W_Text_C_SetFontSize) == 0x000070, "Wrong size on W_Text_C_SetFontSize");
static_assert(offsetof(W_Text_C_SetFontSize, FontSize_0) == 0x000000, "Member 'W_Text_C_SetFontSize::FontSize_0' has a wrong offset!");
static_assert(offsetof(W_Text_C_SetFontSize, CallFunc_Conv_IntToDouble_ReturnValue) == 0x000008, "Member 'W_Text_C_SetFontSize::CallFunc_Conv_IntToDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Text_C_SetFontSize, K2Node_MakeStruct_SlateFontInfo) == 0x000010, "Member 'W_Text_C_SetFontSize::K2Node_MakeStruct_SlateFontInfo' has a wrong offset!");
static_assert(offsetof(W_Text_C_SetFontSize, K2Node_MakeStruct_Size_ImplicitCast) == 0x000068, "Member 'W_Text_C_SetFontSize::K2Node_MakeStruct_Size_ImplicitCast' has a wrong offset!");
...
static_assert(sizeof(W_Text_C_SetStyle) == 0x0000D8, "Wrong size on W_Text_C_SetStyle");
static_assert(offsetof(W_Text_C_SetStyle, TextStyle_0) == 0x000000, "Member 'W_Text_C_SetStyle::TextStyle_0' has a wrong offset!");
static_assert(offsetof(W_Text_C_SetStyle, CallFunc_FTrunc_ReturnValue) == 0x0000C8, "Member 'W_Text_C_SetStyle::CallFunc_FTrunc_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Text_C_SetStyle, CallFunc_FTrunc_A_ImplicitCast) == 0x0000D0, "Member 'W_Text_C_SetStyle::CallFunc_FTrunc_A_ImplicitCast' has a wrong offset!");
...
static_assert(offsetof(W_Text_C_SetText, Text_0) == 0x000000, "Member 'W_Text_C_SetText::Text_0' has a wrong offset!");
...
static_assert(alignof(W_Text_C_SetTextColor) == 0x000004, "Wrong alignment on W_Text_C_SetTextColor");
static_assert(sizeof(W_Text_C_SetTextColor) == 0x000024, "Wrong size on W_Text_C_SetTextColor");
static_assert(offsetof(W_Text_C_SetTextColor, Color_0) == 0x000000, "Member 'W_Text_C_SetTextColor::Color_0' has a wrong offset!");
...
static_assert(offsetof(W_Text_C_SetTextJustification, Justification_0) == 0x000000, "Member 'W_Text_C_SetTextJustification::Justification_0' has a wrong offset!");
...
static_assert(offsetof(W_Text_C_SetTextLetterSpacing, LetterSpacing_0) == 0x000000, "Member 'W_Text_C_SetTextLetterSpacing::LetterSpacing_0' has a wrong offset!");
...
static_assert(alignof(W_Text_C_SetTextShadow) == 0x000008, "Wrong alignment on W_Text_C_SetTextShadow");
static_assert(sizeof(W_Text_C_SetTextShadow) == 0x000020, "Wrong size on W_Text_C_SetTextShadow");
static_assert(offsetof(W_Text_C_SetTextShadow, ShadowOffset_0) == 0x000000, "Member 'W_Text_C_SetTextShadow::ShadowOffset_0' has a wrong offset!");
static_assert(offsetof(W_Text_C_SetTextShadow, ShadowColor_0) == 0x000010, "Member 'W_Text_C_SetTextShadow::ShadowColor_0' has a wrong offset!");
...
static_assert(offsetof(W_Text_C_TruncateText, Truncate_0) == 0x000000, "Member 'W_Text_C_TruncateText::Truncate_0' has a wrong offset!");
static_assert(offsetof(W_Text_C_TruncateText, CharacterLimit_0) == 0x000004, "Member 'W_Text_C_TruncateText::CharacterLimit_0' has a wrong offset!");
static_assert(offsetof(W_Text_C_TruncateText, TruncationCharacters_0) == 0x000008, "Member 'W_Text_C_TruncateText::TruncationCharacters_0' has a wrong offset!");
...
static_assert(offsetof(W_Text_C_UpdateText, Text_0) == 0x000000, "Member 'W_Text_C_UpdateText::Text_0' has a wrong offset!");
