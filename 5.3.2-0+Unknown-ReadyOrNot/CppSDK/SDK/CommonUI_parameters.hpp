...
static_assert(offsetof(CommonCarousel_AddOption, DefaultSelection_0) == 0x000020, "Member 'CommonCarousel_AddOption::DefaultSelection_0' has a wrong offset!");
...
static_assert(offsetof(CommonCarousel_GetOptionAtIndex, Index_0) == 0x000000, "Member 'CommonCarousel_GetOptionAtIndex::Index_0' has a wrong offset!");
