...
static_assert(sizeof(UW_StandardSlider_C) == 0x000438, "Wrong size on UW_StandardSlider_C");
...
static_assert(offsetof(UW_StandardSlider_C, Description_PS5Variant) == 0x000408, "Member 'UW_StandardSlider_C::Description_PS5Variant' has a wrong offset!");
static_assert(offsetof(UW_StandardSlider_C, OnUpdateSliderText) == 0x000420, "Member 'UW_StandardSlider_C::OnUpdateSliderText' has a wrong offset!");
static_assert(offsetof(UW_StandardSlider_C, bManualyUpdateText) == 0x000430, "Member 'UW_StandardSlider_C::bManualyUpdateText' has a wrong offset!");
