...
static_assert(sizeof(W_Memorial_C_ExecuteUbergraph_W_Memorial) == 0x000048, "Wrong size on W_Memorial_C_ExecuteUbergraph_W_Memorial");
...
static_assert(offsetof(W_Memorial_C_ExecuteUbergraph_W_Memorial, K2Node_Event_Delay) == 0x000018, "Member 'W_Memorial_C_ExecuteUbergraph_W_Memorial::K2Node_Event_Delay' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_ExecuteUbergraph_W_Memorial, K2Node_Event_Collapse) == 0x000020, "Member 'W_Memorial_C_ExecuteUbergraph_W_Memorial::K2Node_Event_Collapse' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_ExecuteUbergraph_W_Memorial, K2Node_Event_IsGamepad) == 0x000021, "Member 'W_Memorial_C_ExecuteUbergraph_W_Memorial::K2Node_Event_IsGamepad' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_ExecuteUbergraph_W_Memorial, K2Node_Event_PageName) == 0x000024, "Member 'W_Memorial_C_ExecuteUbergraph_W_Memorial::K2Node_Event_PageName' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_ExecuteUbergraph_W_Memorial, CallFunc_BackPage_Handled) == 0x00002C, "Member 'W_Memorial_C_ExecuteUbergraph_W_Memorial::CallFunc_BackPage_Handled' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_ExecuteUbergraph_W_Memorial, K2Node_ComponentBoundEvent_ButtonID) == 0x000030, "Member 'W_Memorial_C_ExecuteUbergraph_W_Memorial::K2Node_ComponentBoundEvent_ButtonID' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_ExecuteUbergraph_W_Memorial, CallFunc_EqualEqual_StrStr_ReturnValue) == 0x000040, "Member 'W_Memorial_C_ExecuteUbergraph_W_Memorial::CallFunc_EqualEqual_StrStr_ReturnValue' has a wrong offset!");
...
static_assert(alignof(W_Memorial_C_GetSpacerVisibility) == 0x000008, "Wrong alignment on W_Memorial_C_GetSpacerVisibility");
static_assert(sizeof(W_Memorial_C_GetSpacerVisibility) == 0x000058, "Wrong size on W_Memorial_C_GetSpacerVisibility");
...
static_assert(offsetof(W_Memorial_C_GetSpacerVisibility, CallFunc_GetViewportSize_ReturnValue) == 0x000008, "Member 'W_Memorial_C_GetSpacerVisibility::CallFunc_GetViewportSize_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_GetSpacerVisibility, CallFunc_BreakVector2D_X) == 0x000018, "Member 'W_Memorial_C_GetSpacerVisibility::CallFunc_BreakVector2D_X' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_GetSpacerVisibility, CallFunc_BreakVector2D_Y) == 0x000020, "Member 'W_Memorial_C_GetSpacerVisibility::CallFunc_BreakVector2D_Y' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_GetSpacerVisibility, CallFunc_Subtract_DoubleDouble_ReturnValue) == 0x000028, "Member 'W_Memorial_C_GetSpacerVisibility::CallFunc_Subtract_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_GetSpacerVisibility, CallFunc_GetDesiredSize_ReturnValue) == 0x000030, "Member 'W_Memorial_C_GetSpacerVisibility::CallFunc_GetDesiredSize_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_GetSpacerVisibility, CallFunc_BreakVector2D_X_1) == 0x000040, "Member 'W_Memorial_C_GetSpacerVisibility::CallFunc_BreakVector2D_X_1' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_GetSpacerVisibility, CallFunc_BreakVector2D_Y_1) == 0x000048, "Member 'W_Memorial_C_GetSpacerVisibility::CallFunc_BreakVector2D_Y_1' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_GetSpacerVisibility, CallFunc_Greater_DoubleDouble_ReturnValue) == 0x000050, "Member 'W_Memorial_C_GetSpacerVisibility::CallFunc_Greater_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_GetSpacerVisibility, K2Node_Select_Default) == 0x000051, "Member 'W_Memorial_C_GetSpacerVisibility::K2Node_Select_Default' has a wrong offset!");
...
static_assert(alignof(W_Memorial_C_Hide) == 0x000008, "Wrong alignment on W_Memorial_C_Hide");
static_assert(sizeof(W_Memorial_C_Hide) == 0x000010, "Wrong size on W_Memorial_C_Hide");
static_assert(offsetof(W_Memorial_C_Hide, Delay) == 0x000000, "Member 'W_Memorial_C_Hide::Delay' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_Hide, Collapse) == 0x000008, "Member 'W_Memorial_C_Hide::Collapse' has a wrong offset!");
...
static_assert(offsetof(W_Memorial_C_PopulateMemorial, bLastCard) == 0x000008, "Member 'W_Memorial_C_PopulateMemorial::bLastCard' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_PopulateMemorial, NewCard) == 0x000010, "Member 'W_Memorial_C_PopulateMemorial::NewCard' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_PopulateMemorial, NewCharacter) == 0x000018, "Member 'W_Memorial_C_PopulateMemorial::NewCharacter' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_PopulateMemorial, CallFunc_Create_ReturnValue) == 0x000020, "Member 'W_Memorial_C_PopulateMemorial::CallFunc_Create_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_PopulateMemorial, Temp_int_Loop_Counter_Variable) == 0x000028, "Member 'W_Memorial_C_PopulateMemorial::Temp_int_Loop_Counter_Variable' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_PopulateMemorial, CallFunc_Add_IntInt_ReturnValue) == 0x00002C, "Member 'W_Memorial_C_PopulateMemorial::CallFunc_Add_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_PopulateMemorial, Temp_int_Array_Index_Variable) == 0x000030, "Member 'W_Memorial_C_PopulateMemorial::Temp_int_Array_Index_Variable' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_PopulateMemorial, CallFunc_GetSpacerVisibility_ReturnValue) == 0x000034, "Member 'W_Memorial_C_PopulateMemorial::CallFunc_GetSpacerVisibility_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_PopulateMemorial, CallFunc_Add_DoubleDouble_ReturnValue) == 0x000038, "Member 'W_Memorial_C_PopulateMemorial::CallFunc_Add_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_PopulateMemorial, CallFunc_SelectFloat_ReturnValue) == 0x000040, "Member 'W_Memorial_C_PopulateMemorial::CallFunc_SelectFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_PopulateMemorial, K2Node_MakeStruct_Margin) == 0x000048, "Member 'W_Memorial_C_PopulateMemorial::K2Node_MakeStruct_Margin' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_PopulateMemorial, CallFunc_GetMemorialCharacters_ReturnValue) == 0x000058, "Member 'W_Memorial_C_PopulateMemorial::CallFunc_GetMemorialCharacters_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_PopulateMemorial, CallFunc_Array_Get_Item) == 0x000068, "Member 'W_Memorial_C_PopulateMemorial::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_PopulateMemorial, CallFunc_Array_Length_ReturnValue) == 0x000070, "Member 'W_Memorial_C_PopulateMemorial::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_PopulateMemorial, CallFunc_Array_LastIndex_ReturnValue) == 0x000074, "Member 'W_Memorial_C_PopulateMemorial::CallFunc_Array_LastIndex_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_PopulateMemorial, CallFunc_Less_IntInt_ReturnValue) == 0x000078, "Member 'W_Memorial_C_PopulateMemorial::CallFunc_Less_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_PopulateMemorial, CallFunc_EqualEqual_IntInt_ReturnValue) == 0x000079, "Member 'W_Memorial_C_PopulateMemorial::CallFunc_EqualEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_Memorial_C_PopulateMemorial, CallFunc_AddChildToHorizontalBox_ReturnValue) == 0x000080, "Member 'W_Memorial_C_PopulateMemorial::CallFunc_AddChildToHorizontalBox_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(W_Memorial_C_PopulateMemorial, K2Node_MakeStruct_Right_ImplicitCast) == 0x00009C, "Member 'W_Memorial_C_PopulateMemorial::K2Node_MakeStruct_Right_ImplicitCast' has a wrong offset!");
...
static_assert(alignof(W_Memorial_C_Reveal) == 0x000008, "Wrong alignment on W_Memorial_C_Reveal");
static_assert(sizeof(W_Memorial_C_Reveal) == 0x000008, "Wrong size on W_Memorial_C_Reveal");
