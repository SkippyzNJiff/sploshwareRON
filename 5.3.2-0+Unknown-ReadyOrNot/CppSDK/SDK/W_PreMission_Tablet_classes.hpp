...
static_assert(sizeof(UW_PreMission_Tablet_C) == 0x000F80, "Wrong size on UW_PreMission_Tablet_C");
...
static_assert(offsetof(UW_PreMission_Tablet_C, NavigationMap) == 0x000ED0, "Member 'UW_PreMission_Tablet_C::NavigationMap' has a wrong offset!");
static_assert(offsetof(UW_PreMission_Tablet_C, RosterListPopout) == 0x000F20, "Member 'UW_PreMission_Tablet_C::RosterListPopout' has a wrong offset!");
static_assert(offsetof(UW_PreMission_Tablet_C, bRosterOpen) == 0x000F28, "Member 'UW_PreMission_Tablet_C::bRosterOpen' has a wrong offset!");
static_assert(offsetof(UW_PreMission_Tablet_C, ActiveScreen) == 0x000F30, "Member 'UW_PreMission_Tablet_C::ActiveScreen' has a wrong offset!");
static_assert(offsetof(UW_PreMission_Tablet_C, CurrentButtonIndex) == 0x000F38, "Member 'UW_PreMission_Tablet_C::CurrentButtonIndex' has a wrong offset!");
static_assert(offsetof(UW_PreMission_Tablet_C, CurrentButton) == 0x000F40, "Member 'UW_PreMission_Tablet_C::CurrentButton' has a wrong offset!");
static_assert(offsetof(UW_PreMission_Tablet_C, ButtonNavigationDpadDirection) == 0x000F48, "Member 'UW_PreMission_Tablet_C::ButtonNavigationDpadDirection' has a wrong offset!");
static_assert(offsetof(UW_PreMission_Tablet_C, bTabletAwake) == 0x000F4C, "Member 'UW_PreMission_Tablet_C::bTabletAwake' has a wrong offset!");
static_assert(offsetof(UW_PreMission_Tablet_C, bMissionChanged) == 0x000F4D, "Member 'UW_PreMission_Tablet_C::bMissionChanged' has a wrong offset!");
static_assert(offsetof(UW_PreMission_Tablet_C, CurrentZoomDirection) == 0x000F50, "Member 'UW_PreMission_Tablet_C::CurrentZoomDirection' has a wrong offset!");
static_assert(offsetof(UW_PreMission_Tablet_C, ZoomVelocity) == 0x000F58, "Member 'UW_PreMission_Tablet_C::ZoomVelocity' has a wrong offset!");
static_assert(offsetof(UW_PreMission_Tablet_C, RestoreTeamViewOnTabletClosed) == 0x000F60, "Member 'UW_PreMission_Tablet_C::RestoreTeamViewOnTabletClosed' has a wrong offset!");
static_assert(offsetof(UW_PreMission_Tablet_C, OpenTabletPressed) == 0x000F61, "Member 'UW_PreMission_Tablet_C::OpenTabletPressed' has a wrong offset!");
static_assert(offsetof(UW_PreMission_Tablet_C, OpenTabletPressedDuration) == 0x000F68, "Member 'UW_PreMission_Tablet_C::OpenTabletPressedDuration' has a wrong offset!");
static_assert(offsetof(UW_PreMission_Tablet_C, OnScreenChange) == 0x000F70, "Member 'UW_PreMission_Tablet_C::OnScreenChange' has a wrong offset!");
