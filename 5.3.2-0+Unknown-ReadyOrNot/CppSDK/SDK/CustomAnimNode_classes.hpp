...
public:
	...
	{
		return StaticClassImpl<"AnimSuiteMathLibrary">();
	}
...
static_assert(alignof(UAnimSuiteMathLibrary) == 0x000008, "Wrong alignment on UAnimSuiteMathLibrary");
static_assert(sizeof(UAnimSuiteMathLibrary) == 0x000028, "Wrong size on UAnimSuiteMathLibrary");
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"AnimSuiteNodeHelperLibrary">();
	}
...
static_assert(alignof(UAnimSuiteNodeHelperLibrary) == 0x000008, "Wrong alignment on UAnimSuiteNodeHelperLibrary");
static_assert(sizeof(UAnimSuiteNodeHelperLibrary) == 0x000028, "Wrong size on UAnimSuiteNodeHelperLibrary");
