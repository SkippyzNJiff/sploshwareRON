...
static_assert(sizeof(W_WeaponWheel_MagazineDisplay_C_ExecuteUbergraph_W_WeaponWheel_MagazineDisplay) == 0x000044, "Wrong size on W_WeaponWheel_MagazineDisplay_C_ExecuteUbergraph_W_WeaponWheel_MagazineDisplay");
...
static_assert(offsetof(W_WeaponWheel_MagazineDisplay_C_ExecuteUbergraph_W_WeaponWheel_MagazineDisplay, K2Node_Event_MyGeometry) == 0x000004, "Member 'W_WeaponWheel_MagazineDisplay_C_ExecuteUbergraph_W_WeaponWheel_MagazineDisplay::K2Node_Event_MyGeometry' has a wrong offset!");
static_assert(offsetof(W_WeaponWheel_MagazineDisplay_C_ExecuteUbergraph_W_WeaponWheel_MagazineDisplay, K2Node_Event_InDeltaTime) == 0x00003C, "Member 'W_WeaponWheel_MagazineDisplay_C_ExecuteUbergraph_W_WeaponWheel_MagazineDisplay::K2Node_Event_InDeltaTime' has a wrong offset!");
static_assert(offsetof(W_WeaponWheel_MagazineDisplay_C_ExecuteUbergraph_W_WeaponWheel_MagazineDisplay, K2Node_Event_IsDesignTime) == 0x000040, "Member 'W_WeaponWheel_MagazineDisplay_C_ExecuteUbergraph_W_WeaponWheel_MagazineDisplay::K2Node_Event_IsDesignTime' has a wrong offset!");
...
static_assert(sizeof(W_WeaponWheel_MagazineDisplay_C_Initialize) == 0x000018, "Wrong size on W_WeaponWheel_MagazineDisplay_C_Initialize");
...
static_assert(offsetof(W_WeaponWheel_MagazineDisplay_C_Initialize, IconSize_0) == 0x000008, "Member 'W_WeaponWheel_MagazineDisplay_C_Initialize::IconSize_0' has a wrong offset!");
static_assert(offsetof(W_WeaponWheel_MagazineDisplay_C_Initialize, K2Node_VariableSet_MaxAmmo_ImplicitCast) == 0x000010, "Member 'W_WeaponWheel_MagazineDisplay_C_Initialize::K2Node_VariableSet_MaxAmmo_ImplicitCast' has a wrong offset!");
...
static_assert(sizeof(W_WeaponWheel_MagazineDisplay_C_UpdateMagIcon) == 0x000040, "Wrong size on W_WeaponWheel_MagazineDisplay_C_UpdateMagIcon");
...
static_assert(offsetof(W_WeaponWheel_MagazineDisplay_C_UpdateMagIcon, CurrentAmmo) == 0x000008, "Member 'W_WeaponWheel_MagazineDisplay_C_UpdateMagIcon::CurrentAmmo' has a wrong offset!");
static_assert(offsetof(W_WeaponWheel_MagazineDisplay_C_UpdateMagIcon, CallFunc_Array_Get_Item) == 0x000010, "Member 'W_WeaponWheel_MagazineDisplay_C_UpdateMagIcon::CallFunc_Array_Get_Item' has a wrong offset!");
static_assert(offsetof(W_WeaponWheel_MagazineDisplay_C_UpdateMagIcon, CallFunc_MapRangeClamped_ReturnValue) == 0x000018, "Member 'W_WeaponWheel_MagazineDisplay_C_UpdateMagIcon::CallFunc_MapRangeClamped_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_WeaponWheel_MagazineDisplay_C_UpdateMagIcon, CallFunc_Subtract_IntInt_ReturnValue) == 0x000020, "Member 'W_WeaponWheel_MagazineDisplay_C_UpdateMagIcon::CallFunc_Subtract_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_WeaponWheel_MagazineDisplay_C_UpdateMagIcon, CallFunc_Clamp_ReturnValue) == 0x000024, "Member 'W_WeaponWheel_MagazineDisplay_C_UpdateMagIcon::CallFunc_Clamp_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_WeaponWheel_MagazineDisplay_C_UpdateMagIcon, CallFunc_GetMag_Return_Value) == 0x000028, "Member 'W_WeaponWheel_MagazineDisplay_C_UpdateMagIcon::CallFunc_GetMag_Return_Value' has a wrong offset!");
static_assert(offsetof(W_WeaponWheel_MagazineDisplay_C_UpdateMagIcon, CallFunc_GetDynamicMaterial_ReturnValue) == 0x000030, "Member 'W_WeaponWheel_MagazineDisplay_C_UpdateMagIcon::CallFunc_GetDynamicMaterial_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_WeaponWheel_MagazineDisplay_C_UpdateMagIcon, CallFunc_IsValid_ReturnValue) == 0x000038, "Member 'W_WeaponWheel_MagazineDisplay_C_UpdateMagIcon::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_WeaponWheel_MagazineDisplay_C_UpdateMagIcon, CallFunc_SetScalarParameterValue_Value_ImplicitCast) == 0x00003C, "Member 'W_WeaponWheel_MagazineDisplay_C_UpdateMagIcon::CallFunc_SetScalarParameterValue_Value_ImplicitCast' has a wrong offset!");
