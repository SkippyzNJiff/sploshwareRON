...
static_assert(sizeof(W_SubObjective_Entry_C_SetState) == 0x000140, "Wrong size on W_SubObjective_Entry_C_SetState");
...
static_assert(offsetof(W_SubObjective_Entry_C_SetState, CallFunc_SelectFloat_ReturnValue) == 0x000108, "Member 'W_SubObjective_Entry_C_SetState::CallFunc_SelectFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_SubObjective_Entry_C_SetState, CallFunc_SlotAsHorizontalBoxSlot_ReturnValue) == 0x000110, "Member 'W_SubObjective_Entry_C_SetState::CallFunc_SlotAsHorizontalBoxSlot_ReturnValue' has a wrong offset!");
static_assert(offsetof(W_SubObjective_Entry_C_SetState, CallFunc_SelectFloat_ReturnValue_1) == 0x000118, "Member 'W_SubObjective_Entry_C_SetState::CallFunc_SelectFloat_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(W_SubObjective_Entry_C_SetState, K2Node_MakeStruct_Margin) == 0x000120, "Member 'W_SubObjective_Entry_C_SetState::K2Node_MakeStruct_Margin' has a wrong offset!");
static_assert(offsetof(W_SubObjective_Entry_C_SetState, CallFunc_SetRenderOpacity_InOpacity_ImplicitCast) == 0x000130, "Member 'W_SubObjective_Entry_C_SetState::CallFunc_SetRenderOpacity_InOpacity_ImplicitCast' has a wrong offset!");
static_assert(offsetof(W_SubObjective_Entry_C_SetState, K2Node_MakeStruct_Left_ImplicitCast) == 0x000134, "Member 'W_SubObjective_Entry_C_SetState::K2Node_MakeStruct_Left_ImplicitCast' has a wrong offset!");
static_assert(offsetof(W_SubObjective_Entry_C_SetState, K2Node_MakeStruct_Right_ImplicitCast) == 0x000138, "Member 'W_SubObjective_Entry_C_SetState::K2Node_MakeStruct_Right_ImplicitCast' has a wrong offset!");
...
static_assert(offsetof(W_SubObjective_Entry_C_Update, Complete_0) == 0x000000, "Member 'W_SubObjective_Entry_C_Update::Complete_0' has a wrong offset!");
static_assert(offsetof(W_SubObjective_Entry_C_Update, Failed_0) == 0x000001, "Member 'W_SubObjective_Entry_C_Update::Failed_0' has a wrong offset!");
static_assert(offsetof(W_SubObjective_Entry_C_Update, ObjectiveDescription_0) == 0x000008, "Member 'W_SubObjective_Entry_C_Update::ObjectiveDescription_0' has a wrong offset!");
