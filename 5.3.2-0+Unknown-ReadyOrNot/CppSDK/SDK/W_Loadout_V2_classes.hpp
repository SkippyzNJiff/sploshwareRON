...
static_assert(sizeof(UW_Loadout_V2_C) == 0x000C50, "Wrong size on UW_Loadout_V2_C");
...
static_assert(offsetof(UW_Loadout_V2_C, Page_to_FMOD_Tag_Map) == 0x000BF0, "Member 'UW_Loadout_V2_C::Page_to_FMOD_Tag_Map' has a wrong offset!");
static_assert(offsetof(UW_Loadout_V2_C, PresetToDelete) == 0x000C40, "Member 'UW_Loadout_V2_C::PresetToDelete' has a wrong offset!");
