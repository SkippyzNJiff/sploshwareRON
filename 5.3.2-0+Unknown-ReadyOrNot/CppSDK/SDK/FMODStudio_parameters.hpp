...
static_assert(alignof(FMODAudioComponent_GetPaused) == 0x000001, "Wrong alignment on FMODAudioComponent_GetPaused");
static_assert(sizeof(FMODAudioComponent_GetPaused) == 0x000001, "Wrong size on FMODAudioComponent_GetPaused");
static_assert(offsetof(FMODAudioComponent_GetPaused, ReturnValue) == 0x000000, "Member 'FMODAudioComponent_GetPaused::ReturnValue' has a wrong offset!");
