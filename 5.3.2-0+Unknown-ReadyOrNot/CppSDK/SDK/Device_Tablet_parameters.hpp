...
static_assert(sizeof(Device_Tablet_C_ExecuteUbergraph_Device_Tablet) == 0x0008F0, "Wrong size on Device_Tablet_C_ExecuteUbergraph_Device_Tablet");
...
static_assert(offsetof(Device_Tablet_C_ExecuteUbergraph_Device_Tablet, CallFunc_MakeColor_ReturnValue) == 0x0008E0, "Member 'Device_Tablet_C_ExecuteUbergraph_Device_Tablet::CallFunc_MakeColor_ReturnValue' has a wrong offset!");
